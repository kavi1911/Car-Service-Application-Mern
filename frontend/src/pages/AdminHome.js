  ...
  return (
    <DefaultLayout>
     ...
     <div style={{textAlign:'left', margin: '20px 30px'}}>
      <button className="btn btn-primary" onClick={()=>{window.location.href='/addcar'}}><Link style={{color:'white'}}>Add New Car Services</Link></button>
      <button className="btn btn-primary ms-5" onClick={()=>{window.location.href='/adminbookingview'}}><Link style={{color:'white'}}>View Booking</Link></button>
      </div>
      <Row justify='center' >
